...
export const PlusIcon = style => <Icon {...style} name="plus-outline" />;
export const BookIcon = style => <Icon {...style} name="book" />;
export const FileTextIcon = style => (
  <Icon {...style} name="file-text-outline" />
);

export const LogoutIcon = style => <Icon {...style} name="log-out-outline" />;

export const MoonIcon = style => <Icon {...style} name="moon-outline" />;

export const PeopleIcon = style => <Icon {...style} name="people-outline" />;
...
export const BookmarkIcon = style => <Icon {...style} name="bookmark" />;
